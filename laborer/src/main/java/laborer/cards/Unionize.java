...
public class Unionize extends CustomCard {

  public static final String ID = LaborerMod.makeID(Unionize.class.getSimpleName());
  ...
  public void use(AbstractPlayer player, AbstractMonster monster) {
    ...
    AbstractDungeon.actionManager.addToBottom(
        new ChangeStanceAction(new WorkStoppageStance())
    );
  }
