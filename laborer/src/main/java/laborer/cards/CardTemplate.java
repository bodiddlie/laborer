...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = LaborerMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = LaborerMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
