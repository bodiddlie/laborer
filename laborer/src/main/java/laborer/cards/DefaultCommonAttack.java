...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = LaborerMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main LaborerMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and laborer.variable.DefaultCustomVariable
